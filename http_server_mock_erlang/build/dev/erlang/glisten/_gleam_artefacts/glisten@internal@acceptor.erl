...
-type pool(IAW, IAX) :: {pool,
        fun((IAW, glisten@internal@handler:loop_message(IAX), glisten@internal@handler:connection(IAX)) -> glisten@internal@handler:next(IAW, glisten@internal@handler:loop_message(IAX))),
        integer(),
        gleam@erlang@process:name(gleam@otp@factory_supervisor:message(glisten@socket:socket(), gleam@erlang@process:subject(glisten@internal@handler:message(IAX)))),
        fun((glisten@internal@handler:connection(IAX)) -> {IAW,
            gleam@option:option(gleam@erlang@process:selector(IAX))}),
        gleam@option:option(fun((IAW) -> nil)),
        glisten@transport:transport(),
...
-spec start(
    ...
    gleam@erlang@process:name(gleam@otp@factory_supervisor:message(glisten@socket:socket(), gleam@erlang@process:subject(glisten@internal@handler:message(IAZ))))
) -> {ok,
