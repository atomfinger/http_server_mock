...
?DOC(false).
-spec maybe_keep_alive(gleam@http@response:response(LFZ)) -> gleam@http@response:response(LFZ).
...
?DOC(false).
-spec add_date_header(gleam@http@response:response(LFQ)) -> gleam@http@response:response(LFQ).
...
?DOC(false).
-spec connection_close(gleam@http@response:response(LFT)) -> gleam@http@response:response(LFT).
...
?DOC(false).
-spec keep_alive(gleam@http@response:response(LFW)) -> gleam@http@response:response(LFW).
keep_alive(Resp) ->
    gleam@http@response:set_header(
        Resp,
        <<"connection"/utf8>>,
...
?DOC(false).
-spec add_content_length(boolean(), integer()) -> fun((gleam@http@response:response(LGE)) -> gleam@http@response:response(LGE)).
