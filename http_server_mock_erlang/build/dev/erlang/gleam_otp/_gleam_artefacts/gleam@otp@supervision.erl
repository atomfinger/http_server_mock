...
-type child_specification(GAV) :: {child_specification,
        fun(() -> {ok, gleam@otp@actor:started(GAV)} |
...
-spec worker(
    fun(() -> {ok, gleam@otp@actor:started(GAW)} |
        {error, gleam@otp@actor:start_error()})
) -> child_specification(GAW).
worker(Start) ->
...
-spec supervisor(
    fun(() -> {ok, gleam@otp@actor:started(GBB)} |
        {error, gleam@otp@actor:start_error()})
) -> child_specification(GBB).
supervisor(Start) ->
